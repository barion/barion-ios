...
typedef SWIFT_ENUM(NSInteger, ButtonType, open) {
  ...
  ButtonTypeCANCEL = 3,
  ButtonTypeRESEND = 4,
  ButtonTypeADDITIONAL = 5,
  ButtonTypeOOB_OPEN_APP = 6,
};


SWIFT_CLASS("_TtC14ipworks3ds_sdk25ChallengeLeftTimeMyClient")
@interface ChallengeLeftTimeMyClient : NSObject
+ (void)denyDebuggerCheckAuthResponse;
+ (void)functionPtrProtocolError;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC14ipworks3ds_sdk18DarkGrayDeviceInfo")
@interface DarkGrayDeviceInfo : NSObject <CreateTransactionClose>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)queueFireChallengeStatusFirst:(NSData * _Null_unspecified)dataPacket;
- (void)sysctlCANCEL:(NSData * _Null_unspecified)dataPacket;
- (void)getMessageSDKWarnings:(int32_t)errorCode :(NSString * _Null_unspecified)description;
- (void)isNameEqualSecondsFromGMT:(int32_t)logLevel :(NSString * _Null_unspecified)message :(NSString * _Null_unspecified)logType;
- (void)whiteLargeSystem:(NSData * _Null_unspecified)certEncoded :(NSString * _Null_unspecified)certSubject :(NSString * _Null_unspecified)certIssuer :(NSString * _Null_unspecified)status :(int32_t * _Nonnull)accept;
- (void)equalToLinkeditCmd:(NSString * _Null_unspecified)message;
@end


SWIFT_CLASS("_TtC14ipworks3ds_sdk19DirectoryServerInfo")
@interface DirectoryServerInfo : NSObject
- (nonnull instancetype)initWithRID:(NSString * _Nonnull)RID publicKey:(NSString * _Nonnull)publicKey CA:(NSString * _Nonnull)CA;
- (nonnull instancetype)initWithRID:(NSString * _Nonnull)RID KID:(NSString * _Nonnull)KID publicKey:(NSString * _Nonnull)publicKey CA:(NSString * _Nonnull)CA OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithRID:(NSString * _Nonnull)RID publicKey:(NSString * _Nonnull)publicKey CAs:(NSArray<NSString *> * _Nonnull)CAs;
- (nonnull instancetype)initWithRID:(NSString * _Nonnull)RID KID:(NSString * _Nonnull)KID publicKey:(NSString * _Nonnull)publicKey CAs:(NSArray<NSString *> * _Nonnull)CAs OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, LabelType, open) {
  ...
  LabelTypeDEVICE_BINDING = 4,
  LabelTypeWHY_INFO = 5,
  LabelTypeWHY_INFO_TEXT = 6,
  LabelTypeEXPANDABLE_INFO = 7,
  LabelTypeEXPANDABLE_INFO_TEXT = 8,
  LabelTypeSELECTION_LIST = 9,
  LabelTypeDATA_ENTRY_LABEL = 10,
...
- (BOOL)setTextBoxTwoCustomizationWithTextBoxCustomization:(TextBoxCustomization * _Nonnull)textBoxCustomization error:(NSError * _Nullable * _Nullable)error;
...
- (TextBoxCustomization * _Nonnull)getTextBoxTwoCustomization SWIFT_WARN_UNUSED_RESULT;
